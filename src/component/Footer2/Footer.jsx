...
import logo from "../../assets/logocapz2.png"
...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-2xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
       <div>
       <img src={logo} alt='no img' class="w-36" />
       </div>
    ...
    <p className="text-xs text-gray-500">&copy; 2024. Capztone Innovative Solution. All rights reserved.</p>
  </div>
</footer>
  )
}
